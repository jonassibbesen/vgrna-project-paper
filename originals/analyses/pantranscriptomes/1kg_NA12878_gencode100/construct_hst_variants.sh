...
python /public/groups/vg/jsibbese/vgrna/code/vgrna-project-scripts/python/construct_allele_hst_table.py 1kg_NA12878_exons_anno_${1}.vcf.gz 1kg_NA12878_gencode100_${1}.txt.gz hst_variants_${1}.txt
