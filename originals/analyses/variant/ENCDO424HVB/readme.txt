...
aws s3 cp s3://vg-k8s/users/jsibbesen/vgrna/analyses/variant/ENCDO424HVB/ . --recursive --exclude "*" --include "*r2*_unidi.txt.gz" --include "*r2*_unidi_joint.txt.gz" --exclude "*history*" --profile vg-dev
