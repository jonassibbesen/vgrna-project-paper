...
GRAPHS_PREFIX="1kg_EURnonCEU_af002_gencode100_genes"
...
# Merge gbwts
/usr/bin/time -v bash -c 'vg gbwt -p -m -f -o '"${GRAPHS_PREFIX}"'.gbwt $(for i in $(seq 1 22; echo X; echo Y); do echo ${i}/'"${GRAPHS_PREFIX}"'_${i}.gbwt; done)'
