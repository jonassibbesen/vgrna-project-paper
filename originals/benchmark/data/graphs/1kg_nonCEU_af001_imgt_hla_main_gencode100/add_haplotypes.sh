...
GRAPHS_PREFIX="1kg_nonCEU_af001_imgt_hla_main_gencode100"
...
# Map HLA CDS alleles
/usr/bin/time -v bash -c "grep '>' *_cds_alleles_full_pad1k.fa | wc -l; vg mpmap -t ${CPU} -l long -F GAM -x base.xg -g index.gcsa -d index.dist -f <(cat *_cds_alleles_full_pad1k.fa) > cds.gam"
