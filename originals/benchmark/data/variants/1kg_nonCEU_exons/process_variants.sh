...
VARIANTS_PREFIX="1kg_nonCEU_exons"
...
# Create non-CEU samples file
/usr/bin/time -v bash -c "grep -v CEU ${VARSINFO_PREFIX}.panel | grep -v sample | cut -f1 > samples.txt; wc -l samples.txt"
