...
OUT_PREFIX="${QUANTER}_${REF}_real_r1_${REAL}"
...
# Upload expression 
aws s3 sync . s3://vg-k8s/users/jsibbesen/vgrna/benchmark/whole_genome/quantification/kallisto/expression/polya_rna/real_r1/${REAL}/${QUANTER}/${REF}/ --exclude "*" --include "${OUT_PREFIX}*" --no-progress
