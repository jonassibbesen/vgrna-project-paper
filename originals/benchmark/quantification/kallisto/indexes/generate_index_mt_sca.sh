...
OUT_PREFIX="kallisto_index_${REF}_mt_sca"
...
# Upload index
aws s3 sync . s3://vg-k8s/users/jsibbesen/vgrna/benchmark/whole_genome/quantification/kallisto/indexes/${REF}_mt_sca/ --exclude "*" --include "${OUT_PREFIX}*" --no-progress
