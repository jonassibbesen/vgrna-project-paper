...
OUT_PREFIX="salmon_index_${INDEX}_mt_sca"
...
# Upload index
aws s3 sync . s3://vg-k8s/users/jsibbesen/vgrna/benchmark/whole_genome/quantification/salmon/indexes/${INDEX}_mt_sca/ --exclude "*" --include "${OUT_PREFIX}*" --no-progress
