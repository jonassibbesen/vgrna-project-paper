...
setwd("/Users/jonas/Documents/postdoc/sc/projects/vgrna/figures/hst_unique_final/")
...
hst_data <- map_dfr(list.files(path = "../hst_unique", pattern=".*_hst_stats.txt", full.names = T, recursive = T), parse_file)
...
pdf("plots/hst_diversity_final.pdf", height = 6, width = 9, pointsize = 12, useDingbats = F)
hst_data %>%
