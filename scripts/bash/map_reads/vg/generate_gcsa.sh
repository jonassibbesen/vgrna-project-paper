...
# Prune graphs
/usr/bin/time -v bash -c 'for i in $(seq 1 22; echo X; echo Y; echo MT; echo SCA); do echo ${i}; vg prune -p -t '"${CPU}"' -r '"${GRAPH_PREFIX}"'_${i}.pg > '"${GRAPH_PREFIX}"'_${i}_pruned.vg; done'
